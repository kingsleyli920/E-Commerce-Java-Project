					...
					<table class="table table-bordered">
						<tbody>
							...
							<tr class="active">
								...
								<td width="10%">
									<input id="quantity" type="text" name="quantity" value="${item.num}" maxlength="4" size="10">
								</td>
								<td width="15%">
	...
	<script>
		$(function () {
			$(".delete").click(function () {
				if (confirm("确认删除吗？")) {
					var pid = this.id;
					window.location.href="/ECommerce/CartServlet?method=removeCartItemById&pid=" + pid;
				}
			})

			$("#clear").click(function () {
				if (confirm("确认清空吗？")) {
					window.location.href="/ECommerce/CartServlet?method=clearCart";
				}
			})
		})
	</script>
